...
const StyledRangeSlider = styled.div`
  ...
  StyledSlider = styled.div`
    ...
    width: 100%;
  `,
  StyledGoodArea = styled.div<Omit<RangeSliderStyledProps, '$score'>>`
    ...
    font-size: 12px;
  `,
  StyledBadArea = styled.div<Omit<RangeSliderStyledProps, '$score'>>`
    ...
    font-size: 12px;
  `,
  ScoreMark = styled.div<RangeSliderStyledProps>`
    position: absolute;
    top: 0;
